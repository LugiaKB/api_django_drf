...
``` 
This project is set to work with SQLite by default, so the database will be created automatically on the folder of your project.

## Create Super User
To set an super user admin profile for your application, run:
```bash
python manage.py createsuperuser
```
Follow the steps on the terminal and the user will be created.

## Run the application
To serve the project on a port of your localhost, run: 
```bash
